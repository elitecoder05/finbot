...
function LoadingState() {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#111B21' }}>
      <div className="text-sm" style={{ color: '#8696A0' }}>Loading...</div>
    </div>
  )
}
...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ backgroundColor: '#111B21' }}>
      {/* WhatsApp-style logo area */}
      <div className="mb-8 flex flex-col items-center gap-3">
        ...
        <p className="text-sm" style={{ color: '#8696A0' }}>AI-powered accounting assistant</p>
      </div>

      <div
        className="w-full max-w-sm space-y-5 rounded-2xl p-6 shadow-xl"
        style={{ backgroundColor: '#1F2C33' }}
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="block text-xs font-medium" style={{ color: '#8696A0' }}>
              USERNAME
            </label>
            <input
              name="username"
              ...
              className="w-full rounded-xl border-0 px-3 py-2.5 text-sm outline-none focus:ring-2"
              style={{
      ...
      <p className="mt-6 text-xs" style={{ color: '#667781' }}>
