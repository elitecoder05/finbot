                    ...
                    <div className="mt-3 flex flex-col gap-2 md:mt-0 md:w-72">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 rounded-xl bg-zinc-900 px-3 py-2 text-sm text-white disabled:opacity-60 dark:bg-zinc-100 dark:text-zinc-900"
                        >
                        ...
                        <button
                          ...
                          disabled={isProcessing}
                          className="flex-1 rounded-xl border border-red-200 px-3 py-2 text-sm text-red-600 disabled:opacity-60 dark:border-red-900 dark:text-red-400"
                        >
